...
const Product = () => {
  ...
  const handleAddToCart = async () => {
    ...
    try {
      ...
      // Update CartContext with the latest cart from backend
      await refreshCart();

      // Navigate only after cart state is updated
      navigate("/cart");
    } catch (error) {
  ...
  const hasStockInfo = stockValue !== undefined && stockValue !== null;
  const isOutOfStock =
    product.in_stock === false ||
    product.available === false ||
    (hasStockInfo && Number(stockValue) <= 0);
        ...
        <section className="grid overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-sm lg:grid-cols-2">
          ...
          <div className="border-b border-gray-100 bg-white p-4 sm:p-6 lg:border-b-0 lg:border-r lg:p-8">
            ...
            <div className="mt-5 flex flex-wrap items-center gap-x-5 gap-y-2 border-t border-gray-100 pt-5 text-xs text-gray-500">
              ...
              <span className="flex items-center gap-2">
                <PackageCheck size={16} className="text-[#255DD0]" />
                Quality checked
              </span>
            </div>
          </div>
          ...
          <div className="flex flex-col p-5 sm:p-7 lg:p-10">
              ...
              <div className="flex items-center gap-1">
                {Array.from({ length: 5 }).map((_, index) => (
                  <Star
                    ...
                    size={18}
                    className={
                      index + 1 <= Math.round(averageReview)
            ...
            <div className="mt-7 border-y border-gray-100 py-6">
              ...
              <p className="mt-2 text-xs text-gray-500">
                Final price shown at checkout. Taxes and delivery may vary.
              </p>
            </div>
            ...
            <div className="mt-6 grid grid-cols-2 gap-3 sm:grid-cols-3">
              ...
              <div className="rounded-xl border border-gray-100 bg-gray-50 p-3">
                ...
                <p className="mt-1 text-sm font-semibold text-gray-900">
                  {averageReview ? `${averageReview.toFixed(1)} / 5` : "Not rated"}
                </p>
              </div>
              ...
              <div className="rounded-xl border border-gray-100 bg-gray-50 p-3">
                ...
                <p
                  className={`mt-1 text-sm font-semibold ${isOutOfStock ? "text-red-600" : "text-green-600"
                    }`}
                >
            ...
            <div className="mt-7 divide-y divide-gray-100 rounded-xl border border-gray-100 bg-gray-50">
              <div className="flex gap-4 p-4">
                <Truck className="mt-0.5 shrink-0 text-[#255DD0]" size={20} />
                <div>
                  <p className="text-sm font-semibold">Fast & reliable delivery</p>
                  <p className="mt-1 text-xs leading-5 text-gray-500">
                    Delivery availability and estimated time are shown during checkout.
                  </p>
                </div>
              </div>

              <div className="flex gap-4 p-4">
                <RotateCcw className="mt-0.5 shrink-0 text-[#255DD0]" size={20} />
                <div>
                  <p className="text-sm font-semibold">Easy returns</p>
                  <p className="mt-1 text-xs leading-5 text-gray-500">
                    Check the store's return policy before placing your order.
                  </p>
                </div>
              </div>

              <div className="flex gap-4 p-4">
                <ShieldCheck className="mt-0.5 shrink-0 text-[#255DD0]" size={20} />
                <div>
                ...
                {specifications.length > 0 ? (
                  <div className="overflow-hidden rounded-xl border border-gray-100">
                    {specifications.map(([key, value], index) => (
                      <div
                        key={key}
                        className={`grid grid-cols-1 gap-1 px-4 py-3 text-sm sm:grid-cols-3 sm:gap-4 ${index % 2 === 0 ? "bg-gray-50" : "bg-white"
                          }`}
                      >
                  ...
                  <div className="flex items-center gap-3 rounded-xl bg-gray-50 p-4 text-sm text-gray-500">
                    <Info size={18} />
                    No additional specifications have been added for this product.
                  </div>
                )}
              </div>
            )}
            ...
            {openSection === "shipping" && (
              <div className="grid gap-4 px-5 pb-6 sm:grid-cols-2 sm:px-7">
                <div className="rounded-xl border border-gray-100 p-4">
                  <Truck className="text-[#255DD0]" size={20} />
                  <h3 className="mt-3 font-semibold">Delivery</h3>
                  <p className="mt-1 text-sm leading-6 text-gray-500">
                    Delivery options, charges, and estimated arrival are confirmed
                    at checkout.
                  </p>
                </div>

                <div className="rounded-xl border border-gray-100 p-4">
                  <RotateCcw className="text-[#255DD0]" size={20} />
                  <h3 className="mt-3 font-semibold">Returns</h3>
                  <p className="mt-1 text-sm leading-6 text-gray-500">
                    Return eligibility depends on the store's return policy and
              ...
              <div className="border-t border-gray-100 px-5 py-6 sm:px-7">
                ...
                <div className="grid gap-5 rounded-xl bg-gray-50 p-5 sm:grid-cols-[180px_1fr]">
                  ...
                  <div className="flex items-center text-sm text-gray-500">
                    Customers can leave a rating and written review after trying the
                    product.
                  </div>
                </div>
